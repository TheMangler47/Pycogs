...
2. Open CMD and Run The Install Command Given in [Requirements](https://github.com/TheMangler47/Pycogs/blob/main/README.md#requirements) to Install The requests Lib.
